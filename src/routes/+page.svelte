	...
	{#if latestBalloonTelemetry.length > 0}
		<div class="flex px-1 mt-4 flex-wrap-reverse justify-center md:flex-nowrap md:px-7">
			...
			<div class="flex flex-col ">
					...
					<div class="max-h-fit">
						...
						<div class="flex py-1">
							<ThermometerIcon size="24" /><strong class="px-3"
								>{celsiusToFahrenheit(
									latestBalloonTelemetry[latestBalloonTelemetry.length - 1].temperature
								)} °F</strong
							>
						</div>
						<div class="flex py-1">
						...
						<div class="flex py-1">
							<MapPinIcon size="24" /><strong class="px-3"
								>{latestBalloonTelemetry[latestBalloonTelemetry.length - 1].gridSquare.substring(
									0,
									6
								)} - {strCoordinates(
									maidenheadToLatLng(
				...
				<div
					class="flex flex-1 md:flex-none flex-col items-center mt-3 w-full
